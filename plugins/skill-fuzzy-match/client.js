/* @amazing-fish/dsh-plugin-skill-fuzzy-match — client entry (classic-script)
 *
 * DSH loads browser client plugins via <script src> (dsh-client-modules), NOT
 * import(). The entry MUST be a classic script that calls
 * window.__ModuleLoader__.load({ id, factory }) and the factory returns the
 * plugin object ({ inject, apply }). ESM `export default` does NOT work here.
 *
...
window.__ModuleLoader__.load({
	id: "@amazing-fish/dsh-plugin-skill-fuzzy-match",
	factory: (require) => {
